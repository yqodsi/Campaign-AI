    ...
    try {
      Papa.parse(file, {
        ...
        complete: async (results) => {
          ...
          // Import leads to global leads (no campaign assigned)
          ...
          if (res.ok) {
            ...
            toast({
              ...
              description: `Imported ${data.imported} leads, ${data.errors.length} errors`,
            });
            onSuccess?.();
              ...
              <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 rounded-md">
                ...
                <div>
                  <p className="font-medium text-green-900 dark:text-green-100">
                    {results.imported} leads imported successfully
                  </p>
                </div>
              </div>
